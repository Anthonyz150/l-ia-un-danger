...
const THEMES = [
  ...
  { id: 't', title: 'IA & Métiers', desc: 'Automatisation intelligente, nouveaux profils et transition des compétences… l’IA redéfinit l’avenir du travail.', href: '/métiers', color: '59, 130, 246', accent: '#60a5fa' },

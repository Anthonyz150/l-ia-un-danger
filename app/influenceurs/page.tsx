    ...
    <main style={{ 
      ...
      <div style={{ flex: 1, paddingBottom: '60px' }}>
        ...
        <section style={{ 
          ...
          <SectionCard title="Les innovations" textColor="#fb923c" delay={0.1} points={['Création fluide de scripts et d’identités de marque', 'Doublage et traduction de l’audio des vidéos en instantanés pour l’international', 'Disponibilité absolue d’avatars gérés sans contrainte humaine']} />
